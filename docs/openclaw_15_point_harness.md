...
- Gateway runtime upgraded to at least `v2026.3.2` (security baseline)
...
3. **Gateway status endpoint is reachable**
   ...
   - Expected: `connected=true` and gateway runtime compatibility check passes (`GATEWAY_MIN_VERSION >= 2026.3.2`).
